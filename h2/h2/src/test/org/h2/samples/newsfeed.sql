...
INSERT INTO CHANNEL VALUES('H2 org.example.Database Engine' ,
    'https://h2database.com/', 'H2 org.example.Database Engine', 'en-us', LOCALTIMESTAMP, LOCALTIMESTAMP, 'Thomas Mueller');
...
<Project rdf:about="https://h2database.com">
    <name>H2 org.example.Database Engine</name>
    ...
    <shortdesc xml:lang="en">H2 org.example.Database Engine</shortdesc>
