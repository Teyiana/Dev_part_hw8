...
-->
    ...
    &nbsp;&nbsp; <a href="help.jsp?jsessionid=${sessionId}">${text.a.help}</a>
        ...
        <div id="url" style="display: none">
            <h2>H2 org.example.Database URLs</h2>
            <h3>Embedded</h3>
            <p>
            ...
            <p>
            For more information, see <a target="_blank" href="https://h2database.com/html/features.html#database_url">org.example.Database URL Overview</a>.
            </p>
        </div>
